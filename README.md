...
- 俗话说**防人之心不可无**。由于本程序源代码开放，因此任何人都可以编译、发布本程序；别有用心人士、您所在公司可能会植入包括但不限于下载器、捆版软件、垃圾软件、间谍软件、钓鱼软件、木马程序、蠕虫程序、勒索病毒、离职倾向管理系统等不相关甚至有害的组件后，二次发布本程序，并通过其它非GitHub渠道传播。使用这样的二次发布的程序，将引发您的隐私泄露，亦会对本程序原版的声誉造成不利影响。因此推荐从 [GitHub上GeekGeekRun仓库的Release页面](https://github.com/geekgeekrun/geekgeekrun/releases) 下载本程序原版。如果您是从其他地方下载的本程序，下载后请校验 Hash。**使用本程序修改版导致的任何问题，本程序原版概不负责**。
- 本程序**不会上报能够识别出您身份的信息**、**不会向您所在公司及上级/HRBP报告您的求职行为**（本程序没有任何钓鱼行为）、**不会向任何猎头公司泄露您的个人信息**。
- 本程序**没有内置任何付费功能**，**下载**、**使用**是**免费**的，任何包括但不限于人在内的生物都可以**免费获得**、**免费使用**。**作者没有利用本程序赚到过任何人民币**。如果您是从GitHub以外的地方付费后“购买”的本程序，或您被提示“必须付费后才能使用本程序”，那**您大概率被骗了**，或者**您下载到了本程序修改版**。**本程序对此概不负责，请勿找作者商讨退款、售后事宜，相关事宜请咨询卖方**。
- 本程序**不对您的求职过程与结果负责**，为您开聊的职位均在Boss直聘上发布，真实性是由Boss直聘负责的；请**自行甄别为您开聊的公司、认真决定是否参加面试、慎重选择Offer**。
- 请在Boss直聘上自行**屏蔽您不期望投递的公司**；如果您不希望您当前公司的其它员工看到您在Boss直聘上活跃，请**在Boss直聘上屏蔽当前公司及与之关联的公司**。
